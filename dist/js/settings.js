...
var stickyHelpers = __webpack_require__(63);
...
var has = __webpack_require__(3);
var classof = __webpack_require__(9);
var inheritIfRequired = __webpack_require__(55);
var toPrimitive = __webpack_require__(16);
var fails = __webpack_require__(1);
...
var anObject = __webpack_require__(2);
var aPossiblePrototype = __webpack_require__(57);
...
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54);
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35);
/* harmony import */ var core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var core_js_modules_es_string_match__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(64);
...
/* harmony import */ var core_js_modules_web_timers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(66);
...
var app = new Vue({
  ...
  methods: {
    ...
    returnDefaultModalImageInputFileName: function returnDefaultModalImageInputFileName(e) {
      e.target.name = 'shop_start_table_size[modal_background_image_file]';
      var inputText = document.querySelector('#modal_background_image_input_text');
      inputText.name = '';
      inputText.value = '';
    },
    delModalImage: function delModalImage(e) {
      var inputFile = document.querySelector('#modal_background_image_input_file');
      var inputText = document.querySelector('#modal_background_image_input_text');
    ...
    changeEmptyChar1: function changeEmptyChar1(e, table_index) {
      if (e.target.value === '') {
        this.group_settings[table_index].filter_characteristic_1 = '—';
      }
    },
    changeEmptyChar2: function changeEmptyChar2(e, table_index) {
      if (e.target.value === '') {
        this.group_settings[table_index].filter_characteristic_2 = '—';
      }
    },
    changeEmptyChar3: function changeEmptyChar3(e, table_index) {
      if (e.target.value === '') {
  ...
  created: function created() {
    ...
    for (var i = 0; i < this.table_count; i++) {
      numberBlock++;
      this.group_settings.push({
        table_name: document.querySelector("#table_name_".concat(numberBlock)).value,
        category_name: document.querySelector("#category_name_".concat(numberBlock)).value,
